...
(function () {
  ...
  var fromBytes$1 = function (bytes) {
    validateFixedCommandPayload(name, bytes, maxSize$4);
  ...
  var tryToReadErrorDataFrameCommand = function (bytes) {
    ...
    if (id === id$c) {
      try {
        var parameters = fromBytes$1(bytes.slice(COMMAND_HEADER_SIZE));
        return {
          id: id,
          name: name,
  ...
  var TARIFF_NUMBER = 4;
  var PACKED_ENERGY_TYPE_SIZE$1 = 1;
  var ENERGY_SIZE = 4;
  var DATE_SIZE = 3;
  ...
  function setPackedEnergyType(buffer, energyType, energies) {
    var indexShift = 1 + TARIFF_NUMBER;
  ...
  var setDeviceId = function (buffer, _ref3) {
  ...
  var setPackedEnergyWithType$1 = function (buffer, _ref4) {
  ...
  var setEnergyPeriods = function (buffer, periods) {
    periods.forEach(function (period) {
      return setEnergyPeriod(buffer, period);
    });
  };
  var setEventStatus = function (buffer, parameters) {
    buffer.setUint16(fromObject(eventStatusMask, parameters));
  };
  var getPackedEnergiesWithDateSize$1 = function (parameters) {
    if (parameters?.energyType) {
      var energiesNumber = parameters.energies.filter(function (energy) {
        return energy !== null;
      }).length;
      return DATE_SIZE + PACKED_ENERGY_TYPE_SIZE$1 + energiesNumber * ENERGY_SIZE;
    }
  ...
  var maxSize$3 = 2;
  var toBytes$c = function (eventStatus) {
    var buffer = new BinaryBuffer(maxSize$3, true);
  ...
  var toBytes$b = function (parameters) {
    var buffer = new BinaryBuffer(getPackedEnergiesWithDateSize$1(parameters), false);
    setDate(buffer, parameters.date);
    setPackedEnergyWithType$1(buffer, parameters);
  ...
  var mtx1DeviceTypeDescriptorToByte = function (descriptor) {
  ...
  var toBytesMtx = function (type, prefix, revision) {
    ...
    return [prefix ?? 0].concat(_toConsumableArray(bytes), _toConsumableArray(new Array(padLength).fill(0)));
  };
  ...
  var toBytes$9 = function (parameters) {
    return toBytes$d(id$9, toBytes$a(parameters));
  };
  ...
  var toBytes$7 = function (parameters) {
    ...
    return toBytes$d(id$7, buffer.data);
  };

  var id$6 = setDateTime$2;
  var toBytes$6 = function () {
    return toBytes$d(id$6);
  };

  var COMMAND_SIZE = 16;
  var id$5 = getEnergy$1;
  var toBytes$5 = function (parameters) {
    var size = COMMAND_SIZE;
    if (parameters?.energyType) {
      var energiesNumber = parameters.energies.filter(function (energy) {
        return energy !== null;
      }).length;
      size = PACKED_ENERGY_TYPE_SIZE$1 + energiesNumber * ENERGY_SIZE;
    }
  ...
  var setPackedEnergyWithType = function (buffer, _ref) {
  ...
  var toBytes$1 = function (parameters) {
    ...
    return toBytes$d(id$1, [event, index, date.year, date.month, date.date, date.hours, date.minutes, date.seconds, count]);
  };
  ...
  var _fromBytesMap;
  var fromBytesMap = (_fromBytesMap = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_fromBytesMap, id$b, toBytes$c), id$a, toBytes$b), id$9, toBytes$9), id$8, toBytes$8), id$7, toBytes$7), id$6, toBytes$6), id$5, toBytes$5), id$4, toBytes$4), id$3, toBytes$3), id$2, toBytes$2), _defineProperty(_defineProperty(_fromBytesMap, id$1, toBytes$1), id, toBytes));

  // partial command set
  fromBytes = getFromBytes(fromBytesMap);
  getDataSegment = get;
