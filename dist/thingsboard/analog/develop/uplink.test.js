...
(function () {
  ...
  var toBytes$E = function toBytes(commandId, commandSize) {
  ...
  var toBytes$D = function toBytes(commandId) {
    var commandBytes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    var headerData = toBytes$E(commandId, commandBytes.length);
  ...
  var setTime2000$2 = 0x02;
  var setParameter$2 = 0x03;
  var getParameter$2 = 0x04;
  var getArchiveHours$2 = 0x05;
  var getArchiveDays$2 = 0x06;
  var current$1 = 0x07;
  var time2000$1 = 0x09;
  var getArchiveEvents$2 = 0x0b;
  var correctTime2000$2 = 0x0c;
  var status$1 = 0x14;
  var newEvent$1 = 0x15;
  var dayMc$1 = 0x16;
  var hourMc$1 = 0x17;
  var currentMc$1 = 0x18;
  var softRestart$2 = 0x19;
  var getArchiveHoursMc$2 = 0x1a;
  var getArchiveDaysMc$2 = 0x1b;
  var dataSegment$2 = 0x1e;
  var day$1 = 0x20;
  var hour$1 = 0x40;
  var lastEvent$1 = 0x60;
  var getLmicInfo$2 = 0x21f;
  var getBatteryStatus$2 = 0x51f;
  var depassivateBattery$2 = 0x61f;
  var usWaterMeterCommand$2 = 0x71f;
  var exAbsHourMc$1 = 0xa1f;
  var exAbsDayMc$1 = 0xb1f;
  var getExAbsArchiveHoursMc$2 = 0xc1f;
  var getExAbsArchiveDaysMc$2 = 0xd1f;
  var exAbsCurrentMc$1 = 0xf1f;
  var usWaterMeterBatteryStatus$1 = 0x141f;
  var writeImage$2 = 0x2a1f;
  var verifyImage$2 = 0x2b1f;
  var updateRun$2 = 0x2c1f;
  var getArchiveHoursMcEx$2 = 0x301f;
  var hourMcEx$1 = 0x311f;
  var getChannelsStatus$2 = 0x321f;
  var getChannelsTypes$2 = 0x331f;
  ...
  var id$C = correctTime2000$2;
  var name$C = commandNames$1[correctTime2000$2];
  var headerSize$C = 2;
  ...
  var toBytes$C = function toBytes(parameters) {
    ...
    return toBytes$D(id$C, buffer.data);
  };
  ...
  var id$B = current$1;
  var name$B = commandNames$1[current$1];
  var headerSize$B = 2;
  ...
  var toBytes$B = function toBytes(parameters) {
    ...
    return toBytes$D(id$B, buffer.data);
  };
  ...
  var id$A = currentMc$1;
  var name$A = commandNames$1[currentMc$1];
  var headerSize$A = 2;
  ...
  var toBytes$A = function toBytes(parameters) {
    ...
    return toBytes$D(id$A, buffer.getBytesToOffset());
  };
  ...
  var id$z = dataSegment$1;
  var name$z = commandNames[dataSegment$1];
  var headerSize$z = 2;
  var COMMAND_BODY_MIN_SIZE$2 = 2;
  var examples$z = {
    'DataSegment request': {
      id: id$z,
      name: name$z,
  ...
  var toBytes$z = function toBytes(parameters) {
    var buffer = new BinaryBuffer(COMMAND_BODY_MIN_SIZE$2 + parameters.data.length, false);
    setDataSegment(buffer, parameters);
    return toBytes$D(id$z, buffer.data);
  };
  ...
  var id$y = day$1;
  var name$y = commandNames$1[day$1];
  var headerSize$y = 1;
  ...
  var toBytes$y = function toBytes(parameters) {
    ...
    return toBytes$D(id$y, buffer.getBytesToOffset());
  };
  ...
  var id$x = dayMc$1;
  var name$x = commandNames$1[dayMc$1];
  var headerSize$x = 2;
  ...
  var toBytes$x = function toBytes(parameters) {
    ...
    return toBytes$D(id$x, buffer.getBytesToOffset());
  };
  ...
  var id$w = depassivateBattery$2;
  var name$w = commandNames$1[depassivateBattery$2];
  var headerSize$w = 3;
  ...
  var name$v = commandNames$1[exAbsCurrentMc$1];
  var headerSize$v = 3;
  ...
  var toBytes$v = function toBytes(parameters) {
    ...
    return toBytes$D(id$v, buffer.getBytesToOffset());
  };
  ...
  var name$u = commandNames$1[exAbsDayMc$1];
  var headerSize$u = 3;
  ...
  var toBytes$u = function toBytes(parameters) {
    ...
    return toBytes$D(id$u, buffer.getBytesToOffset());
  };
  ...
  var name$t = commandNames$1[exAbsHourMc$1];
  var headerSize$t = 3;
  ...
  var toBytes$t = function toBytes(parameters) {
    ...
    return toBytes$D(id$t, buffer.getBytesToOffset());
  };
  ...
  var id$s = getArchiveDays$2;
  var name$s = commandNames$1[getArchiveDays$2];
  var headerSize$s = 2;
  ...
  var toBytes$s = function toBytes(parameters) {
    ...
    return toBytes$D(id$s, buffer.getBytesToOffset());
  };
  ...
  var id$r = getArchiveDaysMc$2;
  var name$r = commandNames$1[getArchiveDaysMc$2];
  var headerSize$r = 2;
  ...
  var toBytes$r = function toBytes(parameters) {
    ...
    return toBytes$D(id$r, buffer.getBytesToOffset());
  };
  ...
  var id$q = getArchiveEvents$2;
  var name$q = commandNames$1[getArchiveEvents$2];
  var headerSize$q = 2;
  ...
  function toBytes$q(parameters) {
    ...
    return toBytes$D(id$q, buffer.data);
  }
  ...
  var id$p = getArchiveHours$2;
  var name$p = commandNames$1[getArchiveHours$2];
  var headerSize$p = 2;
  var examples$p = {
  ...
  var toBytes$p = function toBytes(parameters) {
    ...
    return toBytes$D(id$p, buffer.getBytesToOffset());
  };
  ...
  var id$o = getArchiveHoursMc$2;
  var name$o = commandNames$1[getArchiveHoursMc$2];
  var headerSize$o = 2;
  ...
  var toBytes$o = function toBytes(parameters) {
    ...
    return toBytes$D(id$o, buffer.getBytesToOffset());
  };
  ...
  var id$n = getArchiveHoursMcEx$2;
  var name$n = commandNames$1[getArchiveHoursMcEx$2];
  var headerSize$n = 3;
  ...
  var toBytes$n = function toBytes(parameters) {
    ...
    return toBytes$D(id$n, buffer.getBytesToOffset());
  };
  ...
  var id$m = getBatteryStatus$2;
  var name$m = commandNames$1[getBatteryStatus$2];
  var headerSize$m = 3;
  ...
  var toBytes$m = function toBytes(parameters) {
    ...
    return toBytes$D(id$m, buffer.data);
  };
  ...
  var id$l = getChannelsStatus$2;
  var name$l = commandNames$1[getChannelsStatus$2];
  var headerSize$l = 3;
  var examples$l = {
  ...
  var toBytes$l = function toBytes(parameters) {
    ...
    return toBytes$D(id$l, buffer.data);
  };
  ...
  var id$k = getChannelsTypes$2;
  var name$k = commandNames$1[getChannelsTypes$2];
  var headerSize$k = 3;
  var examples$k = {
  ...
  var toBytes$k = function toBytes(_ref) {
    ...
    return toBytes$D(id$k, channels.map(function (channel) {
      return channel.type;
    }));
  };
  ...
  var id$j = getExAbsArchiveDaysMc$2;
  var name$j = commandNames$1[getExAbsArchiveDaysMc$2];
  var headerSize$j = 3;
  ...
  var toBytes$j = function toBytes(parameters) {
    ...
    return toBytes$D(id$j, buffer.getBytesToOffset());
  };
  ...
  var id$i = getExAbsArchiveHoursMc$2;
  var name$i = commandNames$1[getExAbsArchiveHoursMc$2];
  var headerSize$i = 3;
  ...
  var toBytes$i = function toBytes(parameters) {
    ...
    return toBytes$D(id$i, buffer.getBytesToOffset());
  };
  ...
  var id$h = getLmicInfo$2;
  var name$h = commandNames$1[getLmicInfo$2];
  var headerSize$h = 3;
  ...
  var toBytes$h = function toBytes(parameters) {
    ...
    return toBytes$D(id$h, buffer.data);
  };
  ...
  var id$g = getParameter$2;
  var name$g = commandNames$1[getParameter$2];
  var headerSize$g = 2;
  var examples$g = {
  ...
  var toBytes$g = function toBytes(parameters) {
    ...
    return toBytes$D(id$g, buffer.data);
  };
  ...
  var id$f = hour$1;
  var name$f = commandNames$1[hour$1];
  var headerSize$f = 1;
  var examples$f = {
  ...
  var toBytes$f = function toBytes(parameters) {
    ...
    return toBytes$D(id$f, buffer.getBytesToOffset());
  };
  ...
  var id$e = hourMc$1;
  var name$e = commandNames$1[hourMc$1];
  var headerSize$e = 2;
  ...
  var toBytes$e = function toBytes(parameters) {
    ...
    return toBytes$D(id$e, buffer.getBytesToOffset());
  };
  ...
  var id$d = hourMcEx$1;
  var name$d = commandNames$1[hourMcEx$1];
  var headerSize$d = 3;
  ...
  var toBytes$d = function toBytes(parameters) {
    ...
    return toBytes$D(id$d, buffer.getBytesToOffset());
  };
  ...
  var name$c = commandNames$1[lastEvent$1];
  var headerSize$c = 1;
  var examples$c = {
    'status for GASI3': {
      id: id$c,
  ...
  var id$b = newEvent$1;
  var name$b = commandNames$1[newEvent$1];
  var headerSize$b = 2;
  ...
  var toBytes$b = function toBytes(parameters) {
    ...
    return toBytes$D(id$b, buffer.getBytesToOffset());
  };
  ...
  var id$a = setParameter$2;
  var name$a = commandNames$1[setParameter$2];
  var headerSize$a = 2;
  ...
  var toBytes$a = function toBytes(parameters) {
    ...
    return toBytes$D(id$a, buffer.data);
  };
  ...
  var id$9 = setTime2000$2;
  var name$9 = commandNames$1[setTime2000$2];
  var headerSize$9 = 2;
  ...
  var toBytes$9 = function toBytes(parameters) {
    ...
    buffer.setUint8(status);
    return toBytes$D(id$9, buffer.data);
  };
  ...
  var name$8 = commandNames$1[signalQuality$1];
  var headerSize$8 = 3;
  ...
  var toBytes$8 = function toBytes(parameters) {
    ...
    buffer.setUint8(ecl);
    return toBytes$D(id$8, buffer.data);
  };
  ...
  var id$7 = softRestart$2;
  var name$7 = commandNames$1[softRestart$2];
  var headerSize$7 = 2;
  ...
  var id$6 = status$1;
  var name$6 = commandNames$1[status$1];
  var headerSize$6 = 2;
  ...
  var toBytes$6 = function toBytes(parameters) {
    ...
    return toBytes$D(id$6, buffer.getBytesToOffset());
  };
  ...
  var id$5 = time2000$1;
  var name$5 = commandNames$1[time2000$1];
  var headerSize$5 = 2;
  ...
  var id$4 = updateRun$2;
  var name$4 = commandNames$1[updateRun$2];
  var headerSize$4 = 3;
  ...
  var name$3 = commandNames$1[usWaterMeterBatteryStatus$1];
  var headerSize$3 = 3;
  ...
  var id$2 = usWaterMeterCommand$2;
  var name$2 = commandNames$1[usWaterMeterCommand$2];
  var headerSize$2 = 3;
  var examples$2 = {
  ...
  var toBytes$2 = function toBytes(parameters) {
    return toBytes$D(id$2, parameters.data);
  };
  ...
  var name$1 = commandNames$1[verifyImage$2];
  var headerSize$1 = 3;
  ...
  var toBytes$1 = function toBytes(parameters) {
    ...
    buffer.setUint8(parameters.status);
    return toBytes$D(id$1, buffer.data);
  };
  ...
  var id = writeImage$2;
  var name = commandNames$1[writeImage$2];
  var headerSize = 3;
