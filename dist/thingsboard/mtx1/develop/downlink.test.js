...
(function () {
  ...
  var name$14 = commandNames[activateRatePlan$1];
  var headerSize$14 = 2;
  var maxSize$14 = 1 + TARIFF_PLAN_SIZE;
  ...
  var toBytes$14 = function toBytes(parameters) {
    ...
    return toBytes$15(id$14, buffer.data);
  };
  ...
  var id$13 = getBv$1;
  var name$13 = commandNames[getBv$1];
  var headerSize$13 = 2;
  ...
  var name$12 = commandNames[getCorrectTime$1];
  var headerSize$12 = 2;
  var maxSize$12 = 0;
  ...
  var name$11 = commandNames[getCriticalEvent$1];
  var headerSize$11 = 2;
  ...
  var toBytes$11 = function toBytes(parameters) {
    return toBytes$15(id$11, [parameters.event, parameters.index]);
  };
  ...
  var name$10 = commandNames[getCurrentStatusMeter$1];
  var headerSize$10 = 2;
  ...
  var name$ = commandNames[getCurrentValues$1];
  var headerSize$ = 2;
  var maxSize$ = 0;
  ...
  var name$_ = commandNames[getDateTime$2];
  var headerSize$_ = 2;
  var maxSize$_ = 0;
  ...
  var toBytes$_ = function toBytes() {
    return toBytes$15(id$_);
  };
  ...
  var name$Z = commandNames[getDayDemand$1];
  var headerSize$Z = 2;
  ...
  var name$Y = commandNames[getDayDemandExport$1];
  var headerSize$Y = 2;
  ...
  var id$X = getDayMaxDemand$1;
  var name$X = commandNames[getDayMaxDemand$1];
  var headerSize$X = 2;
  var maxSize$X = 3;
  ...
  var id$W = getDayMaxDemandExport$1;
  var name$W = commandNames[getDayMaxDemandExport$1];
  var headerSize$W = 2;
  var maxSize$W = 3;
  ...
  var id$V = getDayMaxDemandPrevious$1;
  var name$V = commandNames[getDayMaxDemandPrevious$1];
  var headerSize$V = 2;
  ...
  var name$U = commandNames[getDayProfile$1];
  var headerSize$U = 2;
  var maxSize$U = 3;
  ...
  var fromBytes$U = function fromBytes(_ref) {
  ...
  var toBytes$U = function toBytes(parameters) {
    ...
    return toBytes$15(id$U, buffer.data);
  };
  ...
  var name$T = commandNames[getDemand$2];
  var headerSize$T = 2;
  var maxSize$T = 7;
  ...
  var toBytes$T = function toBytes(parameters) {
    ...
    return toBytes$15(id$T, buffer.data);
  };
  ...
  var name$S = commandNames[getDemandCumulative$1];
  var headerSize$S = 2;
  var maxSize$S = 7;
  ...
  var toBytes$S = function toBytes(parameters) {
    ...
    setDemand(buffer, parameters);
    return toBytes$15(id$S, buffer.data);
  };
  ...
  var name$R = commandNames[getDemandParameters$2];
  var headerSize$R = 2;
  var maxSize$R = 0;
  ...
  var name$Q = commandNames[getDeviceId$1];
  var headerSize$Q = 2;
  ...
  var name$P = commandNames[getDeviceType$1];
  var headerSize$P = 2;
  ...
  var toBytes$O = function toBytes(parameters) {
    ...
    return toBytes$15(id$O, buffer.data);
  };
  ...
  var toBytes$N = function toBytes() {
    ...
    return toBytes$15(id$N, buffer.data);
  };
  ...
  var toBytes$M = function toBytes(parameters) {
    if (parameters.energyType) {
      return toBytes$15(id$M, [parameters.energyType]);
    }
    return toBytes$15(id$M);
  };
  ...
  var toBytes$K = function toBytes(parameters) {
    if (parameters.energyType) {
      return toBytes$15(id$K, [parameters.energyType]);
    }
  ...
  var name$J = commandNames[getEvents$1];
  var headerSize$J = 2;
  ...
  var toBytes$J = function toBytes(parameters) {
    ...
    return toBytes$15(id$J, buffer.data);
  };
  ...
  var name$I = commandNames[getEventsCounters$1];
  var headerSize$I = 2;
  ...
  var name$H = commandNames[getEventStatus$1];
  var headerSize$H = 2;
  ...
  var name$G = commandNames[getExtendedCurrentValues$1];
  var headerSize$G = 2;
  var maxSize$G = 0;
  ...
  var name$F = commandNames[getExtendedCurrentValues2$1];
  var headerSize$F = 2;
  ...
  var name$E = commandNames[getGsmParameters$1];
  var headerSize$E = 2;
  var maxSize$E = 1;
  ...
  var toBytes$E = function toBytes(parameters) {
    return toBytes$15(id$E, [parameters.index]);
  };
  ...
  var name$D = commandNames[getHalfHourDemand$1];
  var headerSize$D = 2;
  var maxSize$D = 3;
  ...
  var toBytes$D = function toBytes(parameters) {
    ...
    setDate$1(buffer, parameters.date);
    return toBytes$15(id$D, buffer.data);
  };
  ...
  var name$C = commandNames[getHalfHourDemandExport$1];
  var headerSize$C = 2;
  var maxSize$C = 3;
  ...
  var name$B = commandNames[getHalfHourDemandPrevious$1];
  var headerSize$B = 2;
  ...
  var name$A = commandNames[getHalfHourEnergies$1];
  var headerSize$A = 2;
  var maxSize$A = 5;
  ...
  var name$z = commandNames[getMagneticFieldThreshold$1];
  var headerSize$z = 2;
  var maxSize$z = 0;
  var accessLevel$z = READ_ONLY;
  var isLoraOnly$z = false;
  ...
  var name$y = commandNames[getMeterInfo$1];
  var headerSize$y = 2;
  var maxSize$y = 0;
  var accessLevel$y = READ_ONLY;
  var isLoraOnly$y = false;
  ...
  var name$x = commandNames[getMonthDemand$1];
  var headerSize$x = 2;
  var maxSize$x = 2;
  var accessLevel$x = READ_ONLY;
  var isLoraOnly$x = false;
  ...
  var name$w = commandNames[getMonthDemandExport$1];
  var headerSize$w = 2;
  var maxSize$w = 2;
  var accessLevel$w = READ_ONLY;
  var isLoraOnly$w = false;
  ...
  var name$v = commandNames[getMonthMaxDemand$1];
  var headerSize$v = 2;
  var maxSize$v = 2;
  var accessLevel$v = READ_ONLY;
  var isLoraOnly$v = false;
  ...
  var toBytes$v = function toBytes(_ref) {
    var year = _ref.year,
      month = _ref.month;
    return toBytes$15(id$v, [year, month]);
  };
  ...
  var name$u = commandNames[getMonthMaxDemandExport$1];
  var headerSize$u = 2;
  var maxSize$u = 2;
  var accessLevel$u = READ_ONLY;
  var isLoraOnly$u = false;
  ...
  var toBytes$u = function toBytes(_ref) {
    var year = _ref.year,
      month = _ref.month;
    return toBytes$15(id$u, [year, month]);
  };
  ...
  var name$t = commandNames[getOperatorParameters$2];
  var headerSize$t = 2;
  var maxSize$t = 0;
  var accessLevel$t = READ_ONLY;
  var isLoraOnly$t = false;
  ...
  var name$s = commandNames[getOperatorParametersExtended3$2];
  var headerSize$s = 2;
  var maxSize$s = 0;
  var accessLevel$s = READ_ONLY;
  var isLoraOnly$s = false;
  ...
  var name$r = commandNames[getQuality$1];
  var headerSize$r = 2;
  var maxSize$r = 2;
  var accessLevel$r = READ_ONLY;
  var isLoraOnly$r = false;
  ...
  var toBytes$r = function toBytes(_ref) {
    var year = _ref.year,
      month = _ref.month;
    return toBytes$15(id$r, [year, month]);
  };
  ...
  var name$q = commandNames[getRatePlanInfo$1];
  var headerSize$q = 2;
  var maxSize$q = 1;
  var accessLevel$q = READ_ONLY;
  var isLoraOnly$q = false;
  ...
  var toBytes$q = function toBytes(parameters) {
    return toBytes$15(id$q, [parameters.tariffTable]);
  };
  ...
  var id$p = getSaldo$1;
  var name$p = commandNames[getSaldo$1];
  var headerSize$p = 2;
  var maxSize$p = 0;
  var accessLevel$p = READ_ONLY;
  var isLoraOnly$p = false;
  ...
  var name$o = commandNames[getSaldoParameters$2];
  var headerSize$o = 2;
  var maxSize$o = 0;
  var accessLevel$o = READ_ONLY;
  var isLoraOnly$o = false;
  ...
  var name$n = commandNames[getSeasonProfile$2];
  var headerSize$n = 2;
  var maxSize$n = 3;
  var accessLevel$n = READ_ONLY;
  var isLoraOnly$n = false;
  ...
  var name$m = commandNames[getSpecialDay$2];
  var headerSize$m = 2;
  var maxSize$m = 3;
  var accessLevel$m = READ_ONLY;
  var isLoraOnly$m = false;
  ...
  var name$l = commandNames[getVersion$1];
  var headerSize$l = 2;
  var maxSize$l = 0;
  var accessLevel$l = READ_ONLY;
  var isLoraOnly$l = false;
  ...
  var name$k = commandNames[prepareRatePlan$1];
  var headerSize$k = 2;
  var maxSize$k = 5;
  ...
  var toBytes$k = function toBytes(parameters) {
    ...
    return toBytes$15(id$k, buffer.data);
  };
  ...
  var name$j = commandNames[resetPowerMaxDay$1];
  var headerSize$j = 2;
  var maxSize$j = 0;
  ...
  var name$i = commandNames[resetPowerMaxMonth$1];
  var headerSize$i = 2;
  var maxSize$i = 0;
  ...
  var name$h = commandNames[runTariffPlan$1];
  var headerSize$h = 2;
  var maxSize$h = 1;
  ...
  var toBytes$h = function toBytes(parameters) {
    return toBytes$15(id$h, [parameters.tariffTable]);
  };
  ...
  var name$g = commandNames[setAccessKey$1];
  var headerSize$g = 2;
  var maxSize$g = 1 + KEY_SIZE;
  ...
  var name$f = commandNames[setCorrectDateTime$1];
  var headerSize$f = 2;
  var maxSize$f = 2;
  var accessLevel$f = READ_ONLY;
  var isLoraOnly$f = false;
  ...
  var toBytes$f = function toBytes(parameters) {
    ...
    return toBytes$15(id$f, buffer.data);
  };
  ...
  var name$e = commandNames[setCorrectTime$1];
  var headerSize$e = 2;
  var maxSize$e = 9;
  ...
  var name$d = commandNames[setDateTime$2];
  var headerSize$d = 2;
  var maxSize$d = 8;
  var accessLevel$d = READ_ONLY;
  var isLoraOnly$d = false;
  ...
  var name$c = commandNames[setDayProfile$2];
  var headerSize$c = 2;
  var maxSize$c = 2 + MAX_PERIODS_NUMBER;
  ...
  var name$b = commandNames[setDemandParameters$2];
  var headerSize$b = 2;
  var maxSize$b = 4;
  ...
  var name$a = commandNames[setDisplayParam$1];
  var headerSize$a = 2;
  var maxSize$a = 33;
  ...
  var fromBytes$a = function fromBytes(bytes) {
    if (bytes.length < 1 || bytes.length > maxSize$a) {
  ...
  var toBytes$a = function toBytes(parameters) {
    return toBytes$15(id$a, [parameters.displayMode].concat(_toConsumableArray(parameters.order)));
  };
  ...
  var name$9 = commandNames[setGsmParameters$1];
  var headerSize$9 = 2;
  var maxSize$9 = 3 + GSM_BLOCK_SIZE + 2;
  ...
  var fromBytes$9 = function fromBytes(bytes) {
    ...
    return getGsmBlock(name$9, bytes);
  };
  var toBytes$9 = function toBytes(parameters) {
    return toBytes$15(id$9, setGsmBlock(parameters));
  };
  ...
  var toBytes$7 = function toBytes(parameters) {
    ...
    return toBytes$15(id$7, buffer.data);
  };
  ...
  var toBytes$6 = function toBytes(parameters) {
    ...
    return toBytes$15(id$6, buffer.data);
  };
  ...
  var toBytes$4 = function toBytes(parameters) {
    ...
    return toBytes$15(id$4, buffer.data);
  };
